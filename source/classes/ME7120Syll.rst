Syllabus:  ME 7120: Finite Element Method Applications, Fall 2016
=======================================================================
...
Email to ensure that it makes it through spam filters to my in box!
You will get a quicker response by email than by any other mode of
communication.
...
Programming will be done in Matlab. Please refer to the extensive
Matlab help menu, including tutorials etc. Simple introductions are available on my
website, and Google is also capable of answering almost any question a
new user has. Matlab is free to students through the `CATS website <https://www.wright.edu/information-technology/services/matlab-software>`_.

`WFEM <http://www.cecs.wright.edu/people/faculty/jslater/classes/fem2/WFEM/wfem.zip>`_: You are required to learn how this code works and use it as a
...
.. [1]
   A change in Matlab caused an apparent failure that was fixed in
   Spring 2012.
